<!-- 滑动组件 -->
<template>
  <div class="ce-swiper-scroll-container">
    <div
      class="cy-row ce-swiper-scroll"
      :class="[direction== 'x' && 'direction-x',direction== 'y' && 'direction-y']"
    >
      <slot name="scrollItems" :scroll-to="scrollTo"></slot>
    </div>
  </div>
</template>
